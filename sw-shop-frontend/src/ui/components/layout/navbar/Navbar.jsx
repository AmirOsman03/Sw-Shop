            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div className="flex items-center space-x-4">
                        <motion.button
                            onClick={toggleMenu}
                            className="p-2 rounded-full transition-all duration-300 hover:bg-gray-100/30 focus:outline-none cursor-pointer"
                            whileTap={{ scale: 0.9 }}
                        >
                            {isMenuOpen ? (
                        ...
                        <button className="p-2 rounded-full transition-all duration-300 hover:bg-gray-100/30 focus:outline-none cursor-pointer">
                    ...
                    <div className="flex items-center space-x-2 lg:space-x-4">
                        <button className="p-2 rounded-full transition-all duration-300 hover:bg-white/20 text-gray-800 focus:outline-none cursor-pointer">
                            <FiUser className="w-6 h-6" />
                        </button>
                        <button className="relative p-2 rounded-full transition-all duration-300 hover:bg-white/20 text-gray-800 focus:outline-none cursor-pointer">
